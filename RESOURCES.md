...
| ----------------------------- | ------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Platform Context Proposal** | [docs/platform-context-proposal.md](./docs/platform-context-proposal.md) | Proposal for maintaining a `PLATFORM_CONTEXT.md` in every project. Explains the problem (agents start cold), the 7-section document structure, the flow, and maintenance rules. Referenced as Phase 0 in the process guide. |
